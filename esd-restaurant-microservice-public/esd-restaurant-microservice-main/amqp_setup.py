...
exchangename="sms_direct"
exchangetype="direct"

# this is to create the exchange, the intermediary between the publisher AND queue
...
# - declaring a single queue 
queue_name = 'sms'
# routing key 
channel.queue_declare(queue=queue_name,durable=True)
# accept a specific routing key - 'sms' 
routing_key = 'sms'
# binding the queue to the exchange and establish the routing key
channel.queue_bind(exchange=exchangename, queue=queue_name, routing_key=routing_key) 

# declaring Email queue -notification_email.py 
queue_name = 'email_invoice'
# routing key 
channel.queue_declare(queue=queue_name,durable=True)
# accept a specific routing key - 'email_invoice' 
routing_key = 'email_invoice'
# binding the queue to the exchange and establish the routing key
channel.queue_bind(exchange=exchangename, queue=queue_name, routing_key=routing_key) 
